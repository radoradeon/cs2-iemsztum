...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/lobbies/{lobby}/coach', [LobbyController::class, 'toggleCoach'])->name('lobbies.coach');
    ...
    Route::get('/matches/live', [LiveMatchController::class, 'index'])->name('matches.live');
