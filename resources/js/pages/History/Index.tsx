...
import { ChevronLeft, Trophy, Calendar, Swords, ChevronRight } from 'lucide-react';
...
export default function HistoryIndex() {
    const { matches } = usePage<any>().props;
    ...
    return (
        <div className="min-h-screen bg-[#070708] text-zinc-300 font-sans selection:bg-yellow-500 selection:text-black pb-20">
            ...
            <main className="max-w-[1400px] mx-auto py-12 px-6">
                <div className="mb-10 flex items-end justify-between border-b border-zinc-800/80 pb-6">
                    <div>
                    ...
                    <div className="text-xs text-zinc-500 font-bold uppercase tracking-widest">
                        Historia rozgrywek, w których brałeś udział
                    </div>
                </div>
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col gap-2 w-full md:w-1/4 p-6 mb-4 md:mb-0">
                                        ...
                                        <div className="flex gap-2">
                                            <span className="bg-yellow-500/20 text-yellow-500 border border-yellow-500/30 px-3 py-1 rounded text-[10px] font-black uppercase drop-shadow-md">{match.format}</span>
                                        </div>
                                    </div>
